...
(define pi 3.14159)
(define radius 10)
(define sphere_volume (* (/ 4 3) pi radius radius radius))
; expect sphere_volume

sphere_volume
; expect 4188.786666666666


;;;Problem 6 (quote form)
...
(cons (car (cdr '(a h))) (car '(a h)))
; expect (h . a)

(eval (eval (cons 'car '('((+ 1 5) (+ 0 1))))))
; expect 6


;;;Problem 7 (begin form)
...
(begin (print 'cs61a) (print 'is) (print 'good) (/ 122 2))
; expect 61

(define a-function (begin (print (+ 43 2)) (* 33 3) (- 1 62)))
; expect a-function
a-function
; expect -61

(begin (+ 65 1) (- 13 14) 8 'bruh)
; expect bruh


;;;Problem 8 (lambda form)

(define test-begin-square (lambda (x) (+ x x) (* x x)))
(test-begin-square 10)
; expect 100
...
(lambda (x) (* 3 4) (print x) (+ x 1) 7)
; expect (lambda (x) (begin (* 3 4) (print x) (+ x 1) 7))
...
(define (exercise hours)
  (cond ((= hours 2) 'healthy)
  ((< hours 1) 'unhealthy)
  (else
    'stopexercising
    )))
...
(define (divisible-by-three x) (= 0 (modulo x 3)))
; expect divisible-by-three

(if (divisible-by-three (cube 13)) 'denero 'hilfinger)
; expect hilfinger

(if (divisible-by-three (cube 3)) 'denero 'hilfinger)
; expect denero
...
(if(> (* 8 9) 100) 'True (if #f 4))
; expect okay

;;;Problem 15 (cond form)
...
(define func (mu (x y) (+ x y z)))
; expect func

(define other_func (lambda (x y z) (func (+ x x y) y)))
; expect other_func
